"""
This module contains a function that allows a user to plot network metrics.
...
def graph(timeMin, timeMax, dims, seed):
    ...
    minute_time = process_time / 60
    print('Time elapsed in seconds: ' + str(process_time))
    print('Time elapsed in mins: ' + str(minute_time))

        

graph(1, 100, (100,100), 5)
